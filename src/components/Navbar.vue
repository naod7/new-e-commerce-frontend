...
<template>
    ...
    <v-app-bar app color="#3853D8" dark >
        ...
        <v-divider vertical class=""></v-divider>
        <v-btn icon class="mx-1" @click="toggleSide">
          <v-badge color="#94D0EF" content="2">
            <!--<router-link to="/carts"><v-icon>mdi-cart-outline</v-icon></router-link>--->
      ...
      <CartSideBar v-if="showSideBar" :cart="cart" :toggleSide="toggleSide"/>
